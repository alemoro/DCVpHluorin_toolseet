...
function setDefaultOptions(){
	...
	call("ij.Prefs.set", "DCVpHluorin.normMethods", "B&W Opening");
	...
	call("ij.Prefs.set", "DCVpHluorin.batchAnalysis", false);
...
function setOptions() {
	...
	Dialog.addRadioButtonGroup("Movie normalization method", newArray("Baseline subtraction", "B&W Opening"), 1, 2, normMethods);
	...
	Dialog.addCheckbox("Evaluate SNR", bInclude);
	...
	*/
	...
	if(bReset){
		...
		call("ij.Prefs.set", "DCVpHluorin.batchAnalysis", batchAnalysis);
