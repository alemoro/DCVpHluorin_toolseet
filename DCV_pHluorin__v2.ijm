...
Modify
	...
	2018.09.10 - add new method for background subtraction based on thresholding the image
*/
...
var sCmds2 = newMenu("ROIs Interacion Menu Tool", newArray("Save ROI", "Measure ROIs", "Fix ROI Manager"));
